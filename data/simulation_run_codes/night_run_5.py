...
codes = [G81Code.RotatedPlanarG81Code(d) for d in [3, 5, 7, 9, 11, 13, 15]]
error_model = BiasedDepolarizingErrorModel(bias = 1000, axis='Z')
...
with open(f"night_run_5.json", "w", encoding="utf-8") as file:
    for entry in data:
